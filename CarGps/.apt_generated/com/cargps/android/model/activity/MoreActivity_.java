    ...
    implements HasViews, OnViewChangedListener
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(layout.activity_more_layout);
    }
    ...
    public void onViewChanged(HasViews hasViews) {
        {
            View view = hasViews.findViewById(id.lvLayout);
            if (view!= null) {
        ...
        {
            View view = hasViews.findViewById(id.aboutLayout);
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    @Override
                    public void onClick(View view) {
                        MoreActivity_.this.aboutLayout();
                    }
        ...
        {
            View view = hasViews.findViewById(id.refundLayout);
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    @Override
                    public void onClick(View view) {
                        MoreActivity_.this.refundLayout();
                    }
        ...
        {
            View view = hasViews.findViewById(id.probLemayout);
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    @Override
                    public void onClick(View view) {
                        MoreActivity_.this.probLemayout();
                    }
        ...
        {
            View view = hasViews.findViewById(id.clausLayout);
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    @Override
                    public void onClick(View view) {
                        MoreActivity_.this.clausLayout();
                    }
